...
| `app/`       | A Python directory that contains code for your Dagster repository                 |
| `app_tests/` | A Python directory that contains tests for `app`                      |
...
Tests can be found in `app_tests` and are run with the following command:

```bash
pytest app_tests
```

As you create Dagster ops and graphs, add tests in `app_tests/` to check that your
